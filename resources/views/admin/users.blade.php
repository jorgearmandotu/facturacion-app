          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="facturasPendientes" value="facturasPendientes">
                            <label class="form-check-label" for="facturasPendientes">Facturas pendientes</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="remisionesPendientes" value="remisionesPendientes">
                            <label class="form-check-label" for="remisionesPendientes">Remisiones pendientes</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="listProductos" value="listProductos">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="createProducts" value="createProducts">
                            <label class="form-check-label" for="createProducts">Creación de productos</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="gestionInventario" value="gestionInventario">
                            <label class="form-check-label" for="gestionInventario">Gestion de inventario</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cargueFacturas" value="cargueFacturas">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="form-check form-check-inline">
                          ...
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="proveedores" value="proveedores">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="configurationCompany" value="configurationCompany">
                            <label class="form-check-label" for="configurationCompany">Configuración de empresa</label>
                          </div>
                          <div class="form-check form-check-inline">
