...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        c.value AS state, reference , costo, profit, sum(lp.stock) as total, lpc.price as price, l2.name as locationMain
        ...
        c.value, p.reference, p.costo, p.profit, lpc.price, locationMain;');
        // DB::statement('CREATE OR REPLACE VIEW products_list_view AS
        // SELECT p.id AS id, p.name AS name, l.name AS line, g.name AS "group", p.code AS code,
